...
urlpatterns = [
    ...
    path('compairition/',views.pose_compairition,name='compairition'),
    path('<slug>/',views.course_detail,name='course'),
    ...
    path('redirect/<course_uid>/',views.redirect_continue_video,name='redirect_continue_video'),
